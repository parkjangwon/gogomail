...
GOGOMAIL_DATABASE_URL=postgres://gogomail:...@postgres:5432/gogomail?sslmode=require
GOGOMAIL_AUTH_JWT_SECRET=change-me
GOGOMAIL_ADMIN_TOKEN=change-me
GOGOMAIL_REDIS_PASSWORD=change-me
GOGOMAIL_STORAGE_BACKEND=s3
GOGOMAIL_DELIVERY_RECIPIENT_BATCH_SIZE=100
GOGOMAIL_MESSAGE_BODY_CACHE_ENTRIES=256
GOGOMAIL_WEBHOOK_DISPATCH_ENABLED=true
APP_LOG_LEVEL=info

# Backup / release verification
GOGOMAIL_BACKUP_DIR=/backups
GOGOMAIL_BACKUP_RETENTION_DAYS=7
GOGOMAIL_RESTORE_REHEARSAL_DATABASE_URL=postgres://...
GOGOMAIL_SECURITY_VERIFY=1
