...
| `GOGOMAIL_PUBLIC_BASE_URL` | Public HTTPS origin used in system email links and open-tracking pixels; no default, and required to be non-local in production |
