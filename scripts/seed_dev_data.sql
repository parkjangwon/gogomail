...
-- ══════════════════════════════════════════════════════════════════════════════
--
-- 조직도 개요 (일반적인 IT 회사 구조, 3계층, ~15명)
--
--   고구마컴퍼니
--   ├── 개발본부  (division)            ← 1계층
--   │   ├── 서비스사업부 (business_unit) ← 2계층
--   │   │   ├── 백엔드팀   — 팀장 김철수(과장), 박지원·오석민(대리), 장인경(주임)
--   │   │   └── 프론트엔드팀 — 팀장 이영희(대리), 송지율(사원)
--   │   └── 기술사업부 (business_unit)  ← 2계층
--   │       └── 인프라팀   — 팀장 강현재(대리), 백우진(사원)
--   ├── 마케팅본부 (division)            ← 1계층
--   │   ├── 브랜드사업부 (business_unit) ← 2계층
--   │   │   └── 브랜드팀   — 팀장 박민준(과장), 심다영(대리), 홍승우(사원)
--   │   └── 성장사업부 (business_unit)  ← 2계층
--   │       └── 퍼포먼스팀 — 팀장 정수연(대리), 한지연(대리)
--   └── 경영지원부 (department)          ← 1계층  (2계층 직접 사용)
--       ├── 인사팀     — 팀장 최준호(차장)
--       └── 재무팀     (담당자 없음)
--
-- ID 체계
--   organizations  (directory):
--     c2000000-...001~003 : 본부/부서 (depth=0)
--     c2100000-...001~004 : 사업부    (depth=1, 개발·마케팅 본부 하위)
--     c3000000-...001~007 : 팀        (depth=1 or 2)
--   organization_units (orgchart):
--     c1000000-...001~003 : 본부/부서
--     c1000000-...004~007 : 사업부
--     c1000000-...011~013 : 개발 팀
--     c1000000-...021~022 : 마케팅 팀
--     c1000000-...031~032 : 경영지원 팀
-- ─────────────────────────────────────────────────────────────────────────────
...
-- 2계층: 사업부 (개발본부·마케팅본부 하위)
INSERT INTO organizations (id, domain_id, parent_id, name, code, depth, order_index, status)
VALUES
  ('c2100000-0000-0000-0000-000000000001', '6049fa6e-d649-44d3-83d2-b548c7e787d5',
   'c2000000-0000-0000-0000-000000000001', '서비스사업부', 'svc',    1, 1, 'active'),
  ('c2100000-0000-0000-0000-000000000002', '6049fa6e-d649-44d3-83d2-b548c7e787d5',
   'c2000000-0000-0000-0000-000000000001', '기술사업부',   'tech',   1, 2, 'active'),
  ('c2100000-0000-0000-0000-000000000003', '6049fa6e-d649-44d3-83d2-b548c7e787d5',
   'c2000000-0000-0000-0000-000000000002', '브랜드사업부', 'brand-bu', 1, 1, 'active'),
  ('c2100000-0000-0000-0000-000000000004', '6049fa6e-d649-44d3-83d2-b548c7e787d5',
   'c2000000-0000-0000-0000-000000000002', '성장사업부',   'growth', 1, 2, 'active')
...
-- 3계층 팀 (개발본부 산하 사업부 하위) / 2계층 팀 (경영지원부 직속)
INSERT INTO organizations (id, domain_id, parent_id, name, code, depth, order_index, status)
VALUES
  -- 서비스사업부 하위 (depth=2)
  ('c3000000-0000-0000-0000-000000000001', '6049fa6e-d649-44d3-83d2-b548c7e787d5',
   'c2100000-0000-0000-0000-000000000001', '백엔드팀',     'be',    2, 1, 'active'),
  ('c3000000-0000-0000-0000-000000000002', '6049fa6e-d649-44d3-83d2-b548c7e787d5',
   'c2100000-0000-0000-0000-000000000001', '프론트엔드팀', 'fe',    2, 2, 'active'),
  -- 기술사업부 하위 (depth=2)
  ('c3000000-0000-0000-0000-000000000003', '6049fa6e-d649-44d3-83d2-b548c7e787d5',
   'c2100000-0000-0000-0000-000000000002', '인프라팀',     'infra', 2, 1, 'active'),
  -- 브랜드사업부 하위 (depth=2)
  ('c3000000-0000-0000-0000-000000000004', '6049fa6e-d649-44d3-83d2-b548c7e787d5',
   'c2100000-0000-0000-0000-000000000003', '브랜드팀',     'brand', 2, 1, 'active'),
  -- 성장사업부 하위 (depth=2)
  ('c3000000-0000-0000-0000-000000000005', '6049fa6e-d649-44d3-83d2-b548c7e787d5',
   'c2100000-0000-0000-0000-000000000004', '퍼포먼스팀',   'perf',  2, 1, 'active'),
  -- 경영지원부 직속 (depth=1, 사업부 없음)
  ('c3000000-0000-0000-0000-000000000006', '6049fa6e-d649-44d3-83d2-b548c7e787d5',
   'c2000000-0000-0000-0000-000000000003', '인사팀',       'hr',    1, 1, 'active'),
  ('c3000000-0000-0000-0000-000000000007', '6049fa6e-d649-44d3-83d2-b548c7e787d5',
   'c2000000-0000-0000-0000-000000000003', '재무팀',       'fin',   1, 2, 'active')
ON CONFLICT (id) DO UPDATE SET domain_id=EXCLUDED.domain_id, parent_id=EXCLUDED.parent_id,
  name=EXCLUDED.name, code=EXCLUDED.code, depth=EXCLUDED.depth,
  order_index=EXCLUDED.order_index, status=EXCLUDED.status;
...
--
-- 구조: 본부(division) → 사업부(business_unit) → 팀(team)
--       경영지원부(department)는 사업부 없이 팀 직속
--
-- c1000000-...001~003 : 본부/부서 레벨
-- c1000000-...004~007 : 사업부 레벨
-- c1000000-...011~013 : 개발본부 산하 팀
-- c1000000-...021~022 : 마케팅본부 산하 팀
-- c1000000-...031~032 : 경영지원부 산하 팀
-- ─────────────────────────────────────────────────────────────────────────────
...
VALUES
  ('c1000000-0000-0000-0000-000000000004',
   '6106af4e-fc44-4a65-890d-55bb35741d6c',
   'c1000000-0000-0000-0000-000000000001', -- 개발본부
   '서비스사업부', '서비스사업부', 'business_unit', '서비스사업부',
   'a1000000-0000-0000-0000-000000000001', -- 김철수 (사업부장 겸직)
   'active'),
  ('c1000000-0000-0000-0000-000000000005',
   '6106af4e-fc44-4a65-890d-55bb35741d6c',
   'c1000000-0000-0000-0000-000000000001', -- 개발본부
   '기술사업부', '기술사업부', 'business_unit', '기술사업부',
   'a1000000-0000-0000-0000-000000000007', -- 강현재 (사업부장 겸직)
   'active'),
  ('c1000000-0000-0000-0000-000000000006',
   '6106af4e-fc44-4a65-890d-55bb35741d6c',
   'c1000000-0000-0000-0000-000000000002', -- 마케팅본부
   '브랜드사업부', '브랜드사업부', 'business_unit', '브랜드사업부',
   'a1000000-0000-0000-0000-000000000003', -- 박민준 (사업부장 겸직)
   'active'),
  ('c1000000-0000-0000-0000-000000000007',
   '6106af4e-fc44-4a65-890d-55bb35741d6c',
   'c1000000-0000-0000-0000-000000000002', -- 마케팅본부
   '성장사업부', '성장사업부', 'business_unit', '성장사업부',
   'a1000000-0000-0000-0000-000000000004', -- 정수연 (사업부장 겸직)
   'active')
ON CONFLICT (id) DO UPDATE SET
...
VALUES
  ('c1000000-0000-0000-0000-000000000011',
   '6106af4e-fc44-4a65-890d-55bb35741d6c',
   'c1000000-0000-0000-0000-000000000004', -- 서비스사업부
   '백엔드팀', '백엔드팀', 'team', '백엔드팀',
   'a1000000-0000-0000-0000-000000000001', -- 김철수
   'active'),
...
VALUES
  ('c1000000-0000-0000-0000-000000000013',
   '6106af4e-fc44-4a65-890d-55bb35741d6c',
   'c1000000-0000-0000-0000-000000000005', -- 기술사업부
   '인프라팀', '인프라팀', 'team', '인프라팀',
...
VALUES
  ('c1000000-0000-0000-0000-000000000021',
   '6106af4e-fc44-4a65-890d-55bb35741d6c',
   'c1000000-0000-0000-0000-000000000006', -- 브랜드사업부
   '브랜드팀', '브랜드팀', 'team', '브랜드팀',
   'a1000000-0000-0000-0000-000000000003', -- 박민준
   'active')
ON CONFLICT (id) DO UPDATE SET
...
VALUES
  ('c1000000-0000-0000-0000-000000000022',
   '6106af4e-fc44-4a65-890d-55bb35741d6c',
   'c1000000-0000-0000-0000-000000000007', -- 성장사업부
...
VALUES
  ('c1000000-0000-0000-0000-000000000031',
   '6106af4e-fc44-4a65-890d-55bb35741d6c',
   'c1000000-0000-0000-0000-000000000003', -- 경영지원부
   '인사팀', '인사팀', 'team', '인사팀',
   'a1000000-0000-0000-0000-000000000005', -- 최준호
   'active'),
...
--
-- title      : 직책 · 직급  (예: "팀장 · 과장", "사업부장 · 과장")
-- role       : 'manager' | 'member'
-- is_primary : 대표 소속 (겸직자의 경우 팀 소속이 primary)
--
-- 겸직 구조:
--   김철수  : 백엔드팀 팀장(P) + 서비스사업부 사업부장(겸) + 개발본부 본부장(겸)
--   강현재  : 인프라팀 팀장(P) + 기술사업부 사업부장(겸)
--   박민준  : 브랜드팀 팀장(P) + 브랜드사업부 사업부장(겸) + 마케팅본부 본부장(겸)
--   정수연  : 퍼포먼스팀 팀장(P) + 성장사업부 사업부장(겸)
--   최준호  : 인사팀 팀장(P) + 경영지원부 부장(겸)
--
-- 직급 체계: 차장(7+) > 과장(5) > 대리(3) > 주임(1) > 사원(신입)
-- ─────────────────────────────────────────────────────────────────────────────
...
VALUES
  ...
  ('b0000000-0000-0000-0000-000000000002',
   'c1000000-0000-0000-0000-000000000004', -- 서비스사업부 (겸직)
   'a1000000-0000-0000-0000-000000000001',
   'manager', '사업부장 · 과장', false),
...
VALUES
  ...
  ('b0000000-0000-0000-0000-000000000016',
   'c1000000-0000-0000-0000-000000000005', -- 기술사업부 (겸직)
   'a1000000-0000-0000-0000-000000000007',
   'manager', '사업부장 · 대리', false);
...
VALUES
  ...
  ('b0000000-0000-0000-0000-000000000021',
   'c1000000-0000-0000-0000-000000000006', -- 브랜드사업부 (겸직)
   'a1000000-0000-0000-0000-000000000003',
   'manager', '사업부장 · 과장', false),
...
VALUES
  ...
  ('b0000000-0000-0000-0000-000000000026',
   'c1000000-0000-0000-0000-000000000007', -- 성장사업부 (겸직)
   'a1000000-0000-0000-0000-000000000004',
   'manager', '사업부장 · 대리', false);
