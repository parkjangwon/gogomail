...
- Domain settings reads now normalize nullable `updated_by` values to an empty string, preventing legacy/default settings rows from failing to load before the form can render.
