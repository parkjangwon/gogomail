...
- Benchmarks: `BenchmarkParsePOP3Command` ~17.4 ns/op, 0 allocs; `BenchmarkWritePOP3Multiline` ~535.9 ns/op, 0 allocs; `BenchmarkIMAPTagFromCommandLine` ~17.8 ns/op, 0 allocs; `BenchmarkIMAPUIDSetResponse` ~76.5 ns/op, 2 allocs.
