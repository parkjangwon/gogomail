...
200. Parsed EML body caching is runtime-tunable with `GOGOMAIL_MESSAGE_BODY_CACHE_ENTRIES` and `GOGOMAIL_MESSAGE_BODY_CACHE_TTL`, and the mail service exposes cache hit/miss/eviction snapshots for operational read-path visibility.
