...
- SearchRequest decoding rejects malformed requested-attribute lists and trailing data after the attribute list instead of silently truncating or ignoring the request tail.
