...
- SearchResultEntry responses are encoded as RFC 4511 application payloads and covered by OpenLDAP `ldapsearch` plaintext, StartTLS, LDAPS, and paged-results smoke tests when the client is available.
