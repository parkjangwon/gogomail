...
- LDAP entries expose AD-style identity attributes (`distinguishedName`, deterministic `objectGUID`, `objectCategory`) alongside the RFC-oriented attributes for clients that cache or render from those fields.
