...
- LDAPMessage decoding rejects non-positive `messageID` values, including zero and negative BER INTEGER encodings, matching RFC 4511 message envelope requirements.
