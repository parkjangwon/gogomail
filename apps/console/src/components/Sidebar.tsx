...
export function Sidebar() {
  ...
  const navigationItems: SideNavigationProps.Item[] = useMemo(() => [
    ...
    },
    {
      ...
      ...e('ops'),
      items: [
        { type: 'link', text: t('nav.message_trace'), href: p('/mail/message-trace') },
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'link', text: t('nav.admin_activity'), href: p('/admin-activity') },
        ...
        { type: 'link', text: t('nav.audit_policy'), href: p('/security/audit-policy') },
        ...
        { type: 'link', text: t('nav.security_posture'), href: p('/security/posture') },
        { type: 'link', text: t('nav.compliance'), href: p('/compliance') },
        { type: 'link', text: t('nav.legal_holds'), href: p('/compliance/legal-holds') },
      ],
    },
    {
      type: 'section',
      ...
      items: [
        ...
        { type: 'link', text: t('nav.seat_usage'), href: p('/storage/seat-usage') },
