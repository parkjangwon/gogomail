...
export const SHORTCUT_GROUPS = [
  ...
  { title: '메일 탐색', items: [['j / k', '다음/이전 메일'], ['↑ / ↓', '목록 이동'], ['o', '선택 메일 열기'], ['Space', '체크박스 선택'], ['Home / End', '첫/마지막 메일'], ['Ctrl+A', '전체 선택'], ['Esc', '닫기 / 해제']] },
  { title: '메일 동작', items: [['r', '회신'], ['a', '전체 회신'], ['f', '전달'], ['e', '보관'], ['v', '편지함으로 이동'], ['#', '삭제'], ['m', '읽음 표시'], ['Shift+M', '읽지 않음'], ['z', '1시간 스누즈'], ['l', '라벨 순환'], ['!', '스팸']] },
