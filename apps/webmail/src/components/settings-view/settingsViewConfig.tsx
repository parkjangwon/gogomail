...
export const SHORTCUT_GROUPS = [
  ...
  { title: '앱 전환', items: [['g  m', '메일'], ['g  c', '캘린더'], ['g  a', '연락처'], ['g  o', '조직도'], ['g  d', '드라이브'], ['g  ,', '설정']] },
  { title: '메일 탐색', items: [['j / k', '다음/이전 메일'], ['↑ / ↓', '목록 이동'], ['Enter / o', '선택 메일 열기'], ['Space / x', '체크박스 선택'], ['Home / End', '첫/마지막 메일'], ['Ctrl+A', '전체 선택'], ['Esc', '닫기 / 해제']] },
