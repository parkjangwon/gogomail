...
function QuickCreatePopover({ day, anchorRect, onClose, onSaveEvent, onSaveTodo, onMoreOptions }: QuickCreatePopoverProps) {
...
function MonthView({ currentDate, events, todos, today, onDayClick, onCellClick, onEventClick, onTodoToggle }: MonthViewProps) {
