              ...
              <div key={attachment.id} style={{ display: 'inline-flex', flexDirection: 'column', gap: '4px', maxWidth: '220px' }}>
                {previewUrl && (
                  <button
                    ...
                    title={`${attachment.filename} 미리보기`}
                ...
                <button
                  ...
                  title={`${attachment.filename} (${fileSize}) 다운로드`}
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: '6px',
                ...
                {isPdf && (
                  ...
                  >
                    ...
                    {pdfPreviewLoadingId === attachment.id ? '로딩 중...' : 'PDF 미리보기'}
                  </button>
                )}
                <button
                ...
                >
                  ...
                  {savingToDriveId === attachment.id ? '저장 중...' : '드라이브에 저장'}
                </button>
              </div>
            );
          })}
