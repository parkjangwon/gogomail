...
func TestParseResourcePathRejectsUnsafeOrUnsupportedPaths(t *testing.T) {
	...
	for _, value := range []string{
		...
		"/caldav/principals/user%2F1",
		"/caldav/principals/user%252F1",
		"/caldav/calendars/user%5C1/work/event-1.ics",
		"/caldav/calendars/user%255C1/work/event-1.ics",
		"/caldav/calendars/user-1/work/event-1.txt",
		"/caldav/calendars/user-1/work%2Fevent.ics",
		"/caldav/calendars/user-1/work%252Fevent.ics",
		"/caldav/calendars/user-1/work/event%5C1.ics",
		"/caldav/calendars/user-1/work/event%255C1.ics",
...
func TestParseResourceHrefRejectsQueryAndFragment(t *testing.T) {
	...
	for _, value := range []string{
		...
		"https://calendar.example.test/caldav/calendars/user-1/work%2Fevent-1.ics",
		"https://calendar.example.test/caldav/calendars/user-1/work%252Fevent-1.ics",
		"https://calendar.example.test/caldav/calendars/user%5C1/work/event-1.ics",
		"https://calendar.example.test/caldav/calendars/user%255C1/work/event-1.ics",
