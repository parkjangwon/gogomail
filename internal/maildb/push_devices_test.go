...
func TestValidateUpsertPushDeviceRequestRejectsUnsafeValues(t *testing.T) {
	...
	tests := []UpsertPushDeviceRequest{
		...
		{UserID: string([]byte{0xff}), Platform: "fcm", Token: "token"},
		...
		{UserID: "user-1", Platform: "fcm", Token: string([]byte{0xff})},
		{UserID: "user-1", Platform: "fcm", Token: "line\nbreak"},
		{UserID: "user-1", Platform: "fcm", Token: "token", Label: string([]byte{0xff})},
